...
class DatabaseManager:
    """Manages ChromaDB for semantic search and paper storage"""
    ...
    def _initialize_collections(self):
        ...
        try:
            # Papers collection for semantic search
        ...
        try:
            ...
            for i in range(len(results["ids"][0])):
                paper_data = {
                    ...
                    "abstract": results["documents"][0][i].replace(results["metadatas"][0][i]["title"], "").strip(),
                    "url": results["metadatas"][0][i]["url"],
                    "similarity_score": 1 - results["distances"][0][i],  # Convert distance to similarity
                    "methods": json.loads(results["metadatas"][0][i]["methods"]),
                    "datasets": json.loads(results["metadatas"][0][i]["datasets"]),
        ...
        try:
            ...
            if results["ids"]:
                ...
                return {
                    ...
                    "abstract": results["documents"][0].replace(metadata["title"], "").strip(),
                    "url": metadata["url"],
